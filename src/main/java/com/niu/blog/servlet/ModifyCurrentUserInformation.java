...
@WebServlet("/modifyCurrentUserInformation")
public class ModifyCurrentUserInformation extends HttpServlet {
...
//			response.sendRedirect("login");
		...
		request.getRequestDispatcher("/modifyCurrentUserInformation.jsp").forward(request, response);
	}
